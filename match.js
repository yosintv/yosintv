...
function formatTimeAMPM(dateTime) {
    ...
    return formattedTime;
       ...
       const previewHtml = 
             ...
             `<!-- ${homeTeamSelectValue} vs ${awayTeamSelectValue} --> 
<div href="${postLinkValue}" class="match-event" id="jm${randomNumbers}s" data-result="vs"> <a title="${homeTeamSelectValue} vs ${awayTeamSelectValue}" > <div id="overlay-match"> <div id="watch-match"></div> </div> </a> <div class="first-team"> <div class="team-logo"> <img loading="lazy" alt="${homeTeamSelectValue}" height="70" src="${homeTeam.logo}" title="${homeTeamSelectValue}" width="70"> </div> <div class="team-name">${homeTeamSelectValue}</div> </div> <div class="match-time" > <div class="match-timing"> <div id="match-hour">${formatTimeAMPM(matchStartValue)}</div> <div id="result-now">${matchResultValue}</div> <span id="mj${randomNumbers}s" class="match-date" data-start="${formattedMatchStart}" data-gameends="${formattedMatchEnd}"></span> </div> </div> <div class="left-team"> <div class="team-logo"> <img loading="lazy" alt="${awayTeamSelectValue}" height="70" src="${awayTeam.logo}" title="${awayTeamSelectValue}" width="70"> </div> <div class="team-name">${awayTeamSelectValue}</div> </div> </div>`;
